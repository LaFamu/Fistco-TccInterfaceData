...
namespace TCC_TCC.A.ETBModel.ExcelModel.InterLock
{
    ...
    public class BitMapBase
    {
        ...
        /// 编号
        /// </summary>
        [MetroExcelModelProperty("数据块中序号", ExcelModelPropertyType.IndexType, true, true)]
        public virtual UInt32 datablockId { get; set; }

        /// <summary>
        /// 名称
        /// </summary>
        [MetroExcelModelProperty("数据块名称", ExcelModelPropertyType.StringType, true, true)]
        public virtual String datablockName { get; set; }
    }
}
